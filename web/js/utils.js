...
//Query blockchain network for data to fill element
...
function addItemToList(item, list_name, click_function) {
    ...
    element.classList.add("text-darken-2")
  //  element.classList.add("brown")
  //  element.classList.add("lighten-2")
...
async function init_web3() {
    ...
    // The interface definition for your smart contract (the ABI) FOR PRODUCT MANAGEMENT
    ...
    window.pm.options.address = '0x423fa2BbA81bEF0a74B3aa684af71CC27e2dF745'
    ...
    window.co.options.address = "0xf8C9A97a860d7FcA0c87a95Fb419978f5413a8D5"
}
